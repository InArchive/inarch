...
import { generateScriptCore } from "./generateScript.js";
import { generateVoiceCore } from "./generateVoice.js";
import { fetchBgCore } from "./fetchBgVideo.js";
import { fetchMusicCore } from "./fetchMusic.js";

export async function startReelCore(event_id, target_date) {
  // 1. Create job
  ...
  // 7. Mark job as ready for render
  await sql`
    UPDATE jobs
